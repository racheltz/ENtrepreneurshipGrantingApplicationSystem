...
import com.harrisonwells.funding.views.applications.InvestorApplicationView;
 ...
 */
public class InvestorLayout extends AppLayout {

    private H2 viewTitle;

    public InvestorLayout() {
    ...
    private AppNav createNavigation() {
        ...
        nav.addItem(new AppNavItem("Dashboard", HomeView.class, LineAwesomeIcon.HOME_SOLID.create()));
        nav.addItem(new AppNavItem("Announcements", AnnouncementView.class, LineAwesomeIcon.NEWSPAPER.create()));
        nav.addItem(new AppNavItem("Applications", InvestorApplicationView.class, LineAwesomeIcon.NEWSPAPER.create()));
        return nav;
    }
