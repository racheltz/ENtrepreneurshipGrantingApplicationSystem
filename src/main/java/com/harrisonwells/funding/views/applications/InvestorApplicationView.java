...
import com.harrisonwells.funding.views.EntrepreneurLayout;
...
@Route(value = "manage-applications", layout = EntrepreneurLayout.class)
@RolesAllowed("ENTREPRENEUR")
public class InvestorApplicationView extends VerticalLayout {


    public InvestorApplicationView(AnnouncementService announcementService) {
